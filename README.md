...
Khi minimize Pet Shelf hoặc chuyển sang ứng dụng khác, pet vẫn tiếp tục hiển thị và chạy animation độc lập trên desktop. Đóng cửa sổ Pet Shelf (nút X) không thoát app: cửa sổ ẩn xuống system tray (icon 🐾), pet vẫn chạy bình thường; bấm icon tray để mở lại giao diện, hoặc chọn **Quit Pet Shelf** trong menu chuột phải của tray để thoát hẳn.
